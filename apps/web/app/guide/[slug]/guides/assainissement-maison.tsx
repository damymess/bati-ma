  ...
  return (
    <>
      ...
      <div className="prose-content">
        <h2>L&apos;assainissement au Maroc : enjeux et solutions</h2>
        <p>
        ...
        <h2>Assainissement collectif : le raccordement au réseau</h2>
        <p>
        ...
        <h2>Assainissement autonome : la fosse septique</h2>
        <p>
        ...
        <h2>Dimensionnement de la fosse septique</h2>
        <p>
        ...
        <h2>Entretien et bonnes pratiques</h2>
        <p>
