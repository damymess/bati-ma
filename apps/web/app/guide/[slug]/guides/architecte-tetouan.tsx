export default function GuideArchitecteTetouan() {
  const faq = [
    ...
    { q: "Pourquoi T\u00e9touan est-elle unique pour la restauration patrimoniale ?", a: "La m\u00e9dina de T\u00e9touan est la seule m\u00e9dina andalouse class\u00e9e UNESCO au Maroc. Ses 5 000 maisons blanches aux toits de tuiles vertes imposent des contraintes sp\u00e9cifiques : chaux traditionnelle, tuiles verniss\u00e9es, menuiserie bois \u00e0 l\u2019identique. Aucune autre ville n\u2019a ce cahier des charges." },
    { q: "Est-ce que T\u00e9touan est en zone sismique \u00e9lev\u00e9e ?", a: "Oui, T\u00e9touan est en zone 3 du RPS 2011 (risque mod\u00e9r\u00e9 \u00e0 \u00e9lev\u00e9). Le s\u00e9isme d\u2019Al Hoceima en 2004 a rappel\u00e9 la vuln\u00e9rabilit\u00e9 du Rif. Tout projet doit respecter les calculs parasismiques renforc\u00e9s : joints de dilatation, poteaux surdimensionn\u00e9s." },
  ];
  const faqSchema = {
