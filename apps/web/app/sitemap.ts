...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/outils/calculateur-cout-construction-maroc`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE}/demande-devis`, lastModified: now, changeFrequency: "weekly", priority: 0.85 },
